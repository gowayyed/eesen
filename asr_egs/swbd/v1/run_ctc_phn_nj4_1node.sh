...
if [ $stage -le 4 ]; then
  ...
  dir=$PROJECTS/exp/swbd_train_phn_nj4_1node_l${lstm_layer_num}_c${lstm_cell_dim}
  mkdir -p $dir
  ...
  steps/train_ctc_parallel_h2.sh --add-deltas true --num-sequence 20 --frame-num-limit 25000 \
    --learn-rate 0.00004 --report-step 1000 --halving-after-epoch 12 --nj 4 --utts-per-avg 10000 \
